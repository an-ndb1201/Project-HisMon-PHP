...
<body>
        ...
        <div class="col-md-10"> 
            ...
            <table class="list table table-striped">
                ...
                <?php  
                $places_set = find_all_places();
                $count = mysqli_num_rows($places_set);
                for ($i = 0; $i < $count; $i++):
                    $places = mysqli_fetch_assoc($places_set);
                    //alternative: mysqli_fetch_row($book_set) returns indexed array
                ?>
                    <tr>
                        <td><?php echo $places['name']; ?></td>
                        <td><?php echo $places['country']; ?></td>
                        <td><?php echo $places['content']; ?></td>
                        <td><?php echo $places['categoryID']; ?></td>
                        <td><?php echo $places['img']; ?></td>
                        <td><a  href="<?php echo 'editplaces.php?placesID='.$places['placesID']; ?>">
                            <button type="button" class="btn btn-warning btn-lg">
                                <span class="gglyphicon glyphicon-pencil"></span>
                            </button>
                        </a></td>
                        <td><a href="<?php echo 'deleteplaces.php?placesID='.$places['placesID']; ?>">
                            <button type="button" class="btn btn-danger btn-lg">
